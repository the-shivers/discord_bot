...
function f_help(msg, content) {
  ...
  // + "**!f trough <fruit> <qty>** - *Add fruit to a trough if you own one.*\n"
  // + "**!f trough auto** - *Automatically fill your trough based on items in your inventory.*\n"
  // + "**!f feed auto** - *Top off your pets using food in the trough if you own one.*\n"
  msg.channel.send(result);
}

function f_pethelp(msg, content) {
  let result = "";
  result += "Every fruitymon command starts with !f followed by a command and possibly options.\n"
  // + "**!f help** - *Shows you this.*\n"
  // + "**!f tiers** - *Shows you what fruits are common/rare.*\n"
...
module.exports = { f_help, f_pethelp };
